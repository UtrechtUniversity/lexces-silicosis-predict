...
for (i in 1:num_repetitions) {
  ...
  # Sample Sensitivity from Beta distribution
...
write.csv(
  ROC_results, 
  file = paste0(tabfolder, "/Hoy_non-dif_low-high.csv"),
  row.names = F
)

cat("Simulation complete! Results saved in the output_tables folder as Hoy_non-dif_low-high.csv\n")
