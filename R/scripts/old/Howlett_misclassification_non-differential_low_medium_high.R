...
write.csv(
  ROC_results, 
  file = paste0(tabfolder, "/Howlett_non-dif_low-med-high.csv"),
  row.names = F
)

cat("Simulation complete! Results saved in the output_tables folder as Howlett_non-dif_low-med-high.csv\n")
